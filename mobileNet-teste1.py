...
base_img_dir = os.path.join(r'C:\Users\Caio\Desktop\smartbee\imagens\baseParaWCAMA\dataset\novaBaseAtualizada\datasetSeparado', 'input')
...
test_res = mn_cnn.evaluate(X_test, y_test, verbose=0)
