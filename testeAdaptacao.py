...
model2=Sequential()
model2.add(Conv2D(CONV_2D_DIM_1, kernel_size=KERNEL_SIZE, input_shape=(IMAGE_WIDTH, IMAGE_HEIGHT,IMAGE_CHANNELS), activation='relu', kernel_regularizer=regularizers.l2(l=0.001), padding='same'))
model2.add(MaxPool2D(MAX_POOL_DIM))
model2.add(Dropout(0.1))
model2.add(Conv2D(CONV_2D_DIM_2, kernel_size=KERNEL_SIZE, activation='relu', kernel_regularizer=regularizers.l2(l=0.001), padding='same'))
model2.add(Dropout(0.1))
model2.add(Flatten())
